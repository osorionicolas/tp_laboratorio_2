...
namespace Entidades_2017
{
    ...
    public class Changuito
    {
        ...
        public enum ETipo
        { Dulce, Snacks, Leche, Todos }

        #region "Constructores"
        private Changuito()
        {
            this._productos = new List<Producto>(this._espacioDisponible);
        }
        ...
        /// <returns></returns>
        public string Mostrar(Changuito c, ETipo tipoDeChanguito) //quitar static
        {
        ...
        public static Changuito operator +(Changuito c, Producto p)
        {
            ...
            if (c._productos.Count.Equals(c._espacioDisponible))
                return c;
            else
                c._productos.Add(p);
